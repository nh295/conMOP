...
public class WalkerOptimizer extends AbstractProblem {
    ...
    public void evaluate(Solution solution) {
        ...
        Walker walker = new Walker("", sma.getValue(), inc.getValue(), 
        ...
        EventAnalysisFactory eaf = new EventAnalysisFactory(startDate, endDate, inertialFrame, cdefSet, propagatorFactory);
